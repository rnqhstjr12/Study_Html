...
<form method = "post" enctype = "multipart/form-data" name = "frm">
	...
	<input type = "hidden" name = "nonmakeImg" value = "${product.imgUrl}">
	<table>
		<tr>
			<td>
				<c:choose>
			...
			<td>
				<table>
					...
					<tr>
						<th>사 진</th>
						<td>
							<input type = "file" name = "imgUrl"><br>(주의사항 : 이미지를 변경하고자 할때만 선택하시오)
						</td>
					</tr>
					<tr>
						<th>설 명</th>
						<td>
							<textarea cols = "90" rows = "10" name = "des">${product.des}</textarea>
						</td>
					</tr>
				</table>
			</td>
